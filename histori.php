...
<table class="table table-hover table-striped">
    ...
    <tbody>
        ...
        ?>
            <tr>
                <td><?=$no?></td><td><?=$dt_histori['tgl_transaksi']?></td><td><?=$dt_histori['nama_member']?></td><td><?=$produk_dibeli?></td><td><?=$qty?></td><td><?=$dt_histori['batas_waktu']?></td><td><?=$dt_histori['tgl_bayar']?></td>
                <?php
                if($dt_histori['status_bayar']=="belum_lunas"){
                    ?>
                    <td><a href="bayar.php?id_transaksi=<?=$dt_histori['id_transaksi']?>" class="btn btn-primary">Bayar</a>
                    <?php
                }else{
                    ?>
